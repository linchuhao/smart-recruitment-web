<template>
  <div class="wrapper">
    ...
    <el-row v-if="jobDeliveryRecord">
      ...
      <el-col :span="3"><div class="grid-content ">职位类型</div></el-col>
    ...
    <div v-for="item in jobDeliveryRecord" v-bind:key="item.id" v-if="jobDeliveryRecord">
      <el-row>
        ...
        <el-col :span="3"><div class="grid-content bg-purple-light">{{item.jobProperty}}</div></el-col>
        <el-col :span="5"><div class="grid-content bg-purple">{{item.jobMinSalary}} - {{item.jobMaxSalary}}</div></el-col>
        <el-col :span="3"><div class="grid-content bg-purple-light">{{item.jobCity}}</div></el-col>
